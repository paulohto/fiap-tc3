...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<ValidacaoDto> validation(MethodArgumentNotValidException exception, HttpServletRequest request) {
        HttpStatus status = HttpStatus.BAD_REQUEST;
        ValidacaoDto validacaoForm = new ValidacaoDto();
